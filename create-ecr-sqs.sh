...
aws cloudformation create-stack --stack-name sqs-order-queue --template-body file://./sqs-order-queue.json 
aws cloudformation create-stack --stack-name sqs-delivery-queue --template-body file://./sqs-delivery-queue.json 
